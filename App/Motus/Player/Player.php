...
class Player
{
    ...
    public function getPlayersElements(): string
    {
        ...
        foreach ($arr_alphabet as $letter) {
            ...
            } else if (isset($_GET['playersletters'])) {
